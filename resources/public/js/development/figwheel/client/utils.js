...
return (new CustomEvent(event_name,(function (){var obj27030 = ({"detail":data});
return obj27030;
})()));
} else {
...
var f = (function (){var pred__27037 = cljs.core._EQ_;
var expr__27038 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27037.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27038))){
return ((function (pred__27037,expr__27038){
return (function (p1__27031_SHARP_){
return console.warn(p1__27031_SHARP_);
});
;})(pred__27037,expr__27038))
} else {
if(cljs.core.truth_(pred__27037.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27038))){
return ((function (pred__27037,expr__27038){
return (function (p1__27032_SHARP_){
return console.debug(p1__27032_SHARP_);
});
;})(pred__27037,expr__27038))
} else {
if(cljs.core.truth_(pred__27037.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27038))){
return ((function (pred__27037,expr__27038){
return (function (p1__27033_SHARP_){
return console.error(p1__27033_SHARP_);
});
;})(pred__27037,expr__27038))
} else {
return ((function (pred__27037,expr__27038){
return (function (p1__27034_SHARP_){
return console.log(p1__27034_SHARP_);
});
;})(pred__27037,expr__27038))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27041){
...
var eval_fn = cljs.core.get.call(null,map__27042__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27044_SHARP_);
});})(new_def))
);
...
return (function (p__27045){
var vec__27046 = p__27045;
var ky = cljs.core.nth.call(null,vec__27046,(0),null);
...
}catch (e27051){if((e27051 instanceof Error)){
var e = e27051;
return not_found;
} else {
throw e27051;
...
//# sourceMappingURL=utils.js.map?rel=1737953119711
