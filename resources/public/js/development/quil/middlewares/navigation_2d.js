...
return cljs.core.merge.call(null,initial_state,p1__21857_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_21858 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_21859 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_21858);
var pos_21860 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_21858);
quil.core.scale.call(null,zoom_21859);

var tr__21761__auto___21861 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_21859) - cljs.core.first.call(null,pos_21860)),(((quil.core.height.call(null) / (2)) / zoom_21859) - cljs.core.second.call(null,pos_21860))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__21761__auto___21861);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1737953113149
